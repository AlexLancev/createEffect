...
export const App: FC = () => {
  ...
  const { users, addUserEffectFn, deleteUserEffectFn, copyUserEffectFn } = useUnit({
    users: $users,
    addUserEffectFn: addUserEffect,
    deleteUserEffectFn: deleteUserEffect,
    copyUserEffectFn: copyUserEffect,
  });
  ...
  const handleAdd = useCallback(
    ...
    [addUserEffectFn, form]
  );

  const handleDelete = useCallback((key: string) => {
    try {
      deleteUserEffectFn(key);
